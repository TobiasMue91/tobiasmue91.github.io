...
role_instructions = {
    "Describer": "Gather detailed requirements and specifications for the tool, which should result in a standalone HTML file with embedded scripts, styling, and optional libraries.",
    "Test Writer": "Write comprehensive tests for the tool based on the description using Cypress.",
    ...
    "Implementer": "Implement the actual tool based on the outline, tests, and decided implementation method. Include comments in the code for better understanding.",
